      ...
      <section id="how-it-works" className="w-full py-24">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="relative">
            ...
            <div className="hidden lg:block absolute top-8 left-0 right-0 h-1 bg-(--secondary)/20"></div>
              ...
              {ItWorks.map((step, index) => (
                <div key={index} className="relative text-center">
                  ...
                  <div
                    ...
                    rounded-full bg-white border-4 border-(--secondary)
                    text-(--secondary) font-bold text-xl shadow-md relative z-10"
                  >
                    {index + 1}
                  </div>
