...
export default function Services() {
  return (
    <>
      <section className="overflow-hidden bg-gray-100 pt-[3rem]">
        <div className="max-w-7xl mx-auto md:px-6 px-4 py-24">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-gray-600 max-w-2xl md:text-md text-sm mx-auto mt-4">
              Comprehensive services designed to protect, grow, and position
              your financial future for long-term success.
            </p>
          </div>
